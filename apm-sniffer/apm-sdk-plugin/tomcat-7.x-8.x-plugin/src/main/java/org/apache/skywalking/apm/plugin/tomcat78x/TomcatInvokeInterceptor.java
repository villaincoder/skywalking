...
public class TomcatInvokeInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    static {
        IS_SERVLET_CONTAINS_HEADER_METHOD_EXIST = MethodUtil.isMethodExist(TomcatInvokeInterceptor.class.getClassLoader(), SERVLET_RESPONSE_CLASS, CONTAINS_HEADER_METHOD, String.class.getName());
